...
REGISTERED_CLASSES = {
    ...
    "EIGCostAFAMethod": "afabench.eig_cost.afa_method.EIGCostAFAMethod",
    # AFA Dataset Classes
    ...
    "MimicIVDataset": "afabench.common.datasets.datasets.MimicIVDataset",
    "MimicIV5ClassDataset": "afabench.common.datasets.datasets.MimicIV5ClassDataset",
